...
public class FootballMatchReportsTest {
	...
	public void test_exception() {
		assertThatExceptionOfType(IllegalArgumentException.class).isThrownBy(() -> FootballMatchReports.onField(13));
	}
	...
	public void test_exception_negative_number() {
		assertThatExceptionOfType(IllegalArgumentException.class).isThrownBy(() -> FootballMatchReports.onField(-1));
	}
}
