...
public class CustomSetTest {
	...
	public void intersectionOfTwoEmptySetsIsAnEmptySet() {
		CustomSet<Integer> actual = new CustomSet<Integer>(Collections.emptyList()).getIntersection(new CustomSet<>(Collections.emptyList()));
	...
	public void intersectionOfAnEmptySetAndNonEmptySetIsAnEmptySet() {
		CustomSet<Character> actual = new CustomSet<Character>(Collections.emptyList()).getIntersection(new CustomSet<>(Arrays.asList('3', '2', '5')));
	...
	public void intersectionOfANonEmptySetAndAnEmptySetIsAnEmptySet() {
		CustomSet<String> actual = new CustomSet<>(Arrays.asList("1", "2", "3", "4")).getIntersection(new CustomSet<>(Collections.emptyList()));
	...
	public void intersectionOfTwoSetsWithNoSharedElementsIsAnEmptySet() {
		CustomSet<Integer> actual = new CustomSet<>(Arrays.asList(1, 2, 3)).getIntersection(new CustomSet<>(Arrays.asList(4, 5, 6)));
	...
	public void intersectionOfTwoSetsWithSharedElementsIsASetOfTheSharedElements() {
		...
		CustomSet<Character> actual = new CustomSet<>(Arrays.asList('1', '2', '3', '4')).getIntersection(new CustomSet<>(Arrays.asList('3', '2', '5')));
	...
	public void differenceOfTwoEmptySetsIsAnEmptySet() {
		CustomSet<String> actual = new CustomSet<String>(Collections.emptyList()).getDifference(new CustomSet<>(Collections.emptyList()));
	...
	public void differenceOfAnEmptySetAndNonEmptySetIsAnEmptySet() {
		CustomSet<Integer> actual = new CustomSet<Integer>(Collections.emptyList()).getDifference(new CustomSet<>(Arrays.asList(3, 2, 5)));
	...
	public void differenceOfANonEmptySetAndAnEmptySetIsTheNonEmptySet() {
		CustomSet<Character> expected = new CustomSet<>(Collections.unmodifiableList(Arrays.asList('1', '2', '3', '4')));
		CustomSet<Character> actual = new CustomSet<>(Arrays.asList('1', '2', '3', '4')).getDifference(new CustomSet<>(Collections.emptyList()));
	...
	public void differenceOfTwoNonEmptySetsIsASetOfElementsThatAreOnlyInTheFirstSet() {
		...
		CustomSet<String> actual = new CustomSet<>(Arrays.asList("3", "2", "1")).getDifference(new CustomSet<>(Arrays.asList("2", "4")));
	...
	public void unionOfTwoEmptySetsIsAnEmptySet() {
		CustomSet<Integer> actual = new CustomSet<Integer>(Collections.emptyList()).getUnion(new CustomSet<>(Collections.emptyList()));
	...
	public void unionOfAnEmptySetAndNonEmptySetIsTheNonEmptySet() {
		...
		CustomSet<Character> actual = new CustomSet<Character>(Collections.emptyList()).getUnion(new CustomSet<>(Collections.singletonList('2')));
	...
	public void unionOfANonEmptySetAndAnEmptySetIsTheNonEmptySet() {
		CustomSet<String> expected = new CustomSet<>(Collections.unmodifiableList(Arrays.asList("1", "3")));
		CustomSet<String> actual = new CustomSet<>(Arrays.asList("1", "3")).getUnion(new CustomSet<>(Collections.emptyList()));
