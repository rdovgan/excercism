...
public class CalculatorConundrumTest {
	...
	public void throwExceptionForUnknownOperation() {
		...
		assertThatExceptionOfType(IllegalOperationException.class).isThrownBy(() -> new CalculatorConundrum().calculate(3, 78, invalidOperation))
	...
	public void throwExceptionForNullAsOperation() {
		assertThatExceptionOfType(IllegalArgumentException.class).isThrownBy(() -> new CalculatorConundrum().calculate(66, 65, null))
	...
	public void throwExceptionForAnEmptyStringOperation() {
		assertThatExceptionOfType(IllegalArgumentException.class).isThrownBy(() -> new CalculatorConundrum().calculate(34, 324, ""))
	...
	public void throwExceptionForDivisionByZero() {
		assertThatExceptionOfType(IllegalOperationException.class).isThrownBy(() -> new CalculatorConundrum().calculate(33, 0, "/"))
